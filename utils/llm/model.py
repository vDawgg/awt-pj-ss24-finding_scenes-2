...
class LLMModel(Model):
    ...
    def run_inference(self, prompt: str, max_new_tokens: int = 128) -> str:
        """
        ...
        """
        tokenized_prompt = self.tokenizer.apply_chat_template(prompt, tokenize=True, add_generation_prompt=True, return_tensors="pt").to("cuda")
