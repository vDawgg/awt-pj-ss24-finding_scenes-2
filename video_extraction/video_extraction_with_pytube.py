...
def download_video_and_subtitles(url: str, output_path='./video/')-> Union[Tuple[str, str], Tuple[str, None]]:
    ...
    try:
        ...
        if video:
            ...
            if not caption_key:
                ...
                return './video/'+video.default_filename, None
        
            subtitles = yt.captions[caption_key]

            if subtitles:
                 return './video/'+video.default_filename, subtitles.generate_srt_captions()
        else:
...
if __name__ == "__main__":
 path, subtitles =  download_video_and_subtitles("https://www.youtube.com/watch?v=HOlcUw465PA")
 print(subtitles)
